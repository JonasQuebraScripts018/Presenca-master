...
import static com.MundoSenai.Presenca.Service.CpfValidator.validateCPF;
...
public class S_Pessoa {
    ...
    public static M_Pessoa getPessoaLogin(String usuario, String senha) {
        usuario = NumberClaener.cleanerNumber(usuario);
        if(usuario.equals("")){
    ...
    public static M_Resposta cadastrarPessoa(String nome, String cpf, String email, String telefone, String dataNasc, String senha, String confsenha) {
        ...
        telefone = NumberClaener.cleanerNumber(telefone);
        if (telefone.equals("")){
            telefone = null;
        }
        if (!senha.equals(confsenha)) {
            ...
            m_pessoa.setCpf(Long.valueOf(NumberClaener.cleanerNumber(cpf)));
            if(telefone != null){
